  ...
  return (
    <Fragment>
      ...
      <div className="container">
        ...
        <div className="row">
          {Array.from({ length: 10 }, (_, i) => (
            <div
              ...
              style={{ backgroundColor: isSelected(i + 1) ? "green" : "transparent" }}
            >
              {i + 1}
            </div>
          ))}
        ...
        <div className="">
          <button onClick={() => setSelectedSeats(Array.from({ length: 10 }, (_, i) => i + 1))}>All</button>
          <button onClick={() => setSelectedSeats([])}>None</button>
          <button onClick={() => alert(`Selected seats: ${selectedSeats}`)}>Book</button>
